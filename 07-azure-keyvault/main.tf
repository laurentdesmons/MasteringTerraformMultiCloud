...
module "keyvault" {
  ...
  keyvault = {
    ...
    resource_group_name = module.resource_groups.resource_groups[var.keyvault.resource_group_key].name
    location            = module.resource_groups.resource_groups[var.keyvault.resource_group_key].location
